...
@Component({
  selector: 'app-setup-state-model',
  templateUrl: './setup-state-model.component.html'
})
export class SetupStateModelComponent implements OnInit {
  ...
  constructor(public modelBoardService: HeijunkaBoardService, private stateModelService: StateModelService) { }
