...
export class CfdDataGenerator {
    ...
    constructor() {
        this.stateModel = new StateModel('CfdDataGenerator', 'CfdDataGenerator', this.states, this.states[0], [this.states[2]], this.states[2]);
        this.stateModel.setSuccessorOf(this.states[0],this.states[1]);
        this.stateModel.setSuccessorOf(this.states[1],this.states[2]);
